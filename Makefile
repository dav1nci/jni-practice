...
win:
	...
	java -Djava.library.path=lib/ -classpath bin/ com.sock.Application 10.115.66.185 10.115.66.185 8888
...
run:
	java -Djava.library.path=lib/ -jar UDP.jar 10.115.66.185 10.115.55.185 8888
